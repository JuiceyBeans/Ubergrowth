...
public class VVBlockTagsGenerator extends FabricTagProvider<Block> {
    public VVBlockTagsGenerator(FabricDataOutput output, CompletableFuture registriesFuture) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.getOrCreateTagBuilder(BlockTags.MINEABLE_WITH_PICKAXE)
                ...
                .add(WAXED_COPPER_PLATING)
                .add(WAXED_EXPOSED_COPPER_PLATING)
                .add(WAXED_WEATHERED_COPPER_PLATING)
                .add(WAXED_OXIDIZED_COPPER_PLATING)
                .add(GOLD_PLATING)
                .add(IRON_PLATING)
